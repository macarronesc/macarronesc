...
<p align="center">
  <a href="https://macarronesc.github.io"><img src="https://img.shields.io/badge/Portfolio-macarronesc.github.io-0078d4?style=flat-square&logo=google-chrome&logoColor=white"/></a>
  <a href="https://linkedin.com/in/macarronesc"><img src="https://img.shields.io/badge/LinkedIn-macarronesc-0077b5?style=flat-square&logo=linkedin&logoColor=white"/></a>
</p>
...
### 🧠 LiteRAG — Zero-LLM GraphRAG Framework
...
### 🎬 Klipso — AI Video Editing SaaS &nbsp; [![Live](https://img.shields.io/badge/Live-klipso.vercel.app-000?style=flat-square&logo=vercel)](https://klipso.vercel.app/)
...
### 🚀 PyRun Cloud — Serverless PaaS with Agentic AI &nbsp; [![Live](https://img.shields.io/badge/Live-pyrun.cloud-000?style=flat-square&logo=vercel)](https://pyrun.cloud)
...
### ⚙️ Lithops — Multi-Cloud Serverless Computing &nbsp; *Core Contributor*
...
| **AWS EC2 Standalone** — Dynamic VM provisioning with `Create`/`Reuse`/`Consume` lifecycle modes | New compute backend from scratch |
...
|:--|:--|:--|
| **[Ollama](https://github.com/ollama/ollama)** | Go | Low-level runtime optimizations reducing model loading latency |
| **[Google Gemini CLI](https://github.com/google-gemini/gemini-cli)** | TypeScript | Tool orchestration layer for autonomous agentic workflows |
| **[Dask CloudProvider](https://github.com/dask/dask-cloudprovider)** | Python | New IBM Code Engine backend outperforming commercial alternatives |
